...
<section class="playlist">
   ...
   <?php
      $select_songs = $conn->prepare("SELECT u.user_name, s.name, s.language, s.artist, s.album, s.music FROM `songs` AS s LEFT JOIN `users` AS u ON s.user_id = u.user_id");
   ...
   <div class="box <?= $fetch_song['language']; ?>" >
      ...
      <?php } ?>
      <div class="user"><?= $fetch_song['user_name']; ?></div>
   ...
   ?>
   <div class="boxUpload more-btn">
      <a href="index.php/?upload=1" class="btn">upload music</a>
   </div>
